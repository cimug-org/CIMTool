...
source of content for the CIMTool website at https://cimtool.ucaiug.io/release-notes/. A new
...
image::readme-images/Eclipse_Product_Export.png[Eclipse Product Export dialog,700]
...
The `sign-cimtool-release.bat` script located in the `CIMToolProduct/` directory
...
image::readme-images/Step1.png[Step 1 Insert EV USB Token and SafeNet PIN prompt]


*Step 1 — JAR signing complete / Step 2 — CIMTool.exe signing begins:*

image::readme-images/Step2.png[Step 1 complete\, Step 2 SafeNet PIN prompt]
...
image::readme-images/Step3.png[Step 2 complete\, Step 3 ZIP creation progress]

*Steps 3 and 4 complete — Successful completion summary:*

image::readme-images/Step4.png[Steps 3 and 4 complete\, final summary]
...
image::{docdir}/readme-images/Release_Artifacts.png[GitHub Release Assets upload area,700]
