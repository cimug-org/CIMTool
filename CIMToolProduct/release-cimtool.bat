...
REM
REM  Example:
REM  release-cimtool.bat D:\CIMTool-Releases CIMTool-2.3.0-RC10
REM =============================================================================
...
if "%EXPORT_ROOT%"=="" (
    ...
    echo Example: release-cimtool.bat D:\CIMTool-Releases CIMTool-2.3.0-RC10
    exit /b 1
)
