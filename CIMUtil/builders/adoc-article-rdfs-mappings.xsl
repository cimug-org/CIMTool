...
<xsl:stylesheet version="3.0" 
	...
	<xsl:template match="a:SimpleType">
		...
		<xsl:apply-templates select="a:Simple|a:Enumerated" mode="non-mapped"/>
		<item>|===</item>
		<item></item>	
	</xsl:template>
