...
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Class)
public class Rule043_ClassCIMDatatypeMustHaveStandardAttributes extends OntResourceBaseRule {

	public Rule043_ClassCIMDatatypeMustHaveStandardAttributes(String baseURI) {
		super(baseURI);
	}
	...
	public void then(@Fact("resource") OntResource resource, @Fact("namesMap") Map<String, List<String>> namesMap,
		...
		createRuleViolation(resource, namesMap,
				"«CIMDatatype» Class {name} is missing required attributes: " + missing + ".");
	}
}