...
@Rule(name = "Unused Class", description = "Detects extension classes with no instances or subclasses")
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Class, severity = RuleSeverity.INFO, errorTemplate = "Extension {elementTypeLowerCase} {name} is unused within the model.")
public class ExtensionClassUnusedRule extends OntResourceBaseRule {

	public ExtensionClassUnusedRule(String baseURI) {
		super(baseURI);
	}
