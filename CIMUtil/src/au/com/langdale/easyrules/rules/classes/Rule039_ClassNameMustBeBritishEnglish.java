...
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Class, errorTemplate = "{elementType} {name} must be named using British English. Suggested {elementTypeLowerCase} renaming: {correctedValue}.")
public class Rule039_ClassNameMustBeBritishEnglish extends OntResourceBaseRule {

	public Rule039_ClassNameMustBeBritishEnglish(String baseURI) {
		super(baseURI);
	}
