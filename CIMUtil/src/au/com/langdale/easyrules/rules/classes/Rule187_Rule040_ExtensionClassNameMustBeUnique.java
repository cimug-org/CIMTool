...
@Rule(name = "Rule187:Rule040", description = "[Rule040] All class names shall be unique")
@RuleMetadata(compositeRule = "Rule187", compositeSubRule = "Rule040", type = RuleType.Extension, category = RuleCategory.Class, errorTemplate = "Extension {elementTypeLowerCase} {fullyQualifiedName} is not globally unique. Duplicate(s) detected:\n {fullyQualifiedClasses}")
public class Rule187_Rule040_ExtensionClassNameMustBeUnique extends OntResourceBaseRule {

	public Rule187_Rule040_ExtensionClassNameMustBeUnique(String baseURI) {
		super(baseURI);
	}
