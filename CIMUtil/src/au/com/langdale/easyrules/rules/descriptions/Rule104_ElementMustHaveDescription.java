...
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Description, errorTemplate = "{elementType} {name} is missing a description.")
public class Rule104_ElementMustHaveDescription extends OntResourceBaseRule {

	public Rule104_ElementMustHaveDescription(String baseURI) {
		super(baseURI);
	}
