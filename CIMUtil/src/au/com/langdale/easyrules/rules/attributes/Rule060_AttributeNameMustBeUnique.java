...
@Rule(name = "Rule060", description = "Attribute names shall be unique among all levels of specialisation.")
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Attribute, errorTemplate = "{elementType} {name} is not unique among all levels of specialisation. Duplicate identified:\n {duplicateAttributes}")
public class Rule060_AttributeNameMustBeUnique extends OntResourceBaseRule {

	public Rule060_AttributeNameMustBeUnique(String baseURI) {
		super(baseURI);
	}
