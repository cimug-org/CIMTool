...
@Rule(name = "Rule055", description = "Attribute data types shall be one of the stereotyped CIM classes (i.e. shall not be one of the Enterprise Architect native data types).")
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Attribute, errorTemplate = "{elementType} {name} has a declared type of {declaredType} which is an Enterprise Architect native data type. The declared type must be one of the standard CIM data types: «Primitive», «CIMDatatype», «Compound», or «enumeration». From within Sparx EA you must reselect the desired declared type for the attribute.")
public class Rule055_AttributeDataTypeMustNotBeNativeEADataType extends DBBaseRule {

	public Rule055_AttributeDataTypeMustNotBeNativeEADataType(String baseURI, boolean selfHealingEnabled,
	...
	protected String getRuleErrorMsg(ResultSet resultSet, OntResource resource, Map<String, List<String>> namesMap) {
		...
		String template = "{elementType} {name} has an invalid or unrecognized declared type {declaredType}. The declared type must be one of the standard CIM data types: «Primitive», «CIMDatatype», «Compound», or «enumeration». From within Sparx EA you must reselect the desired declared type for the attribute.";
