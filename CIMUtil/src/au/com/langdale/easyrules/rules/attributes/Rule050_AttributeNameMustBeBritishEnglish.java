...
@Rule(name = "Rule050", description = "Names for attributes shall be British English names.")
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Attribute, errorTemplate = "{elementType} {name} must be named using British English. Suggested {elementTypeLowerCase} renaming: {correctedValue}.")
public class Rule050_AttributeNameMustBeBritishEnglish extends OntResourceBaseRule {

	public Rule050_AttributeNameMustBeBritishEnglish(String baseURI) {
		super(baseURI);
	}
