...
@Rule(name = "Extension:Rule089", description = "[Rule089] Enumeration literals must be unique among all levels of specialisation.")
@RuleMetadata(compositeRule = "Extension", compositeSubRule = "Rule089", type = RuleType.Extension, category = RuleCategory.Enumeration, errorTemplate = "Extension {elementTypeLowerCase} {name} is not unique among all levels of specialisation. Duplicate identified: {duplicateEnumLiteral}")
public class Extension_Rule089_EnumerationLiteralNameMustBeUnique extends OntResourceBaseRule {

	public Extension_Rule089_EnumerationLiteralNameMustBeUnique(String baseURI) {
		super(baseURI);
	}
