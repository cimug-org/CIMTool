...
@Rule(name = "Rule092", description = "Enumeration literals scope is public (by UML definition).")
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Enumeration, errorTemplate = "{elementType} {name} is defined as *'{scope}'* but must be *'Public'*. The model should be corrected.")
public class Rule092_EnumerationLiteralScopeMustBePublic extends DBBaseRule {

	public Rule092_EnumerationLiteralScopeMustBePublic(String baseURI, boolean selfHealingEnabled,
