...
@Rule(name = "Rule090", description = "All enumeration literals shall use the stereotype «enum».")
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Enumeration, severity = RuleSeverity.WARN, errorTemplate = "{elementType} {name} must use the stereotype «enum».")
public class Rule090_EnumerationLiteralMustHaveAnEnumStereotype extends OntResourceBaseRule {

	public Rule090_EnumerationLiteralMustHaveAnEnumStereotype(String baseURI) {
		super(baseURI);
	}
