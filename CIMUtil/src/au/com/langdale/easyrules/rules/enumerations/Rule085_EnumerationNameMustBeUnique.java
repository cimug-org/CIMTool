...
@Rule(name = "Rule085", description = "All enumeration classes shall have unique names")
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Enumeration, errorTemplate = "{elementType} {name} is not globally unique (duplicate detected).")
public class Rule085_EnumerationNameMustBeUnique extends OntResourceBaseRule {

	public Rule085_EnumerationNameMustBeUnique(String baseURI) {
		super(baseURI);
	}
