...
@Rule(name = "Extension:Rule084", description = "[Rule084] An extension enumeration shall be a UML class with the «enumeration» stereotype.")
@RuleMetadata(compositeRule = "Extension", compositeSubRule = "Rule084", type = RuleType.Extension, category = RuleCategory.Enumeration, errorTemplate = "Extension {elementTypeLowerCase} {name} is defined in the model to be of UML type *'Enumeration'*. It is required that it be defined as a UML *'Class'* with an «enumeration» stereotype. This should be corrected in the model.")
public class Extension_Rule084_EnumerationMustBeUMLClass extends DBBaseRule {

	private static final String ENUMERATION = "Enumeration";

	public Extension_Rule084_EnumerationMustBeUMLClass(String baseURI, boolean selfHealingEnabled,
