...
@Rule(name = "Rule037", description = "DetailedDiagram packages should be specified as 'private' packages in Enterprise Architect package properties, so they can be filtered out of diagrams showing the sub-packages.")
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Package, errorTemplate = "Diagrams {elementNameLowerCase} {name} located in package {packageHierarchy} should be specified as 'private' in the Enterprise Architect package properties. This is necessary so it can be filtered out of diagrams showing the sub-packages.")
public class Rule037_PackageDetailedDiagramPackagesShouldBePrivate extends DBBaseRule {

	public Rule037_PackageDetailedDiagramPackagesShouldBePrivate(String baseURI, boolean selfHealingEnabled,
