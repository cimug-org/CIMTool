...
@Rule(name = "Rule025", description = "Names for extension packages shall use the Upper Camel Case naming convention")
...
public class Rule025_ExtensionPackageNameMustBeUpperCamelCase extends OntResourceBaseRule {

	public Rule025_ExtensionPackageNameMustBeUpperCamelCase(String baseURI) {
		super(baseURI);
	}
