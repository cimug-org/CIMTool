...
@Rule(name = "Rule176", description = "All extension packages containing classes shall have unique names (i.e., the package containment hierarchy shall not be used in uniquely identifying a package).")
@RuleMetadata(type = RuleType.Extension, category = RuleCategory.Package, errorTemplate = "Extension {elementTypeLowerCase} {name} defined in package {packageHierarchy} is not globally unique. Consider using another name or adding a prefix to the name of the package. The detected duplicate(s) include:\n\n {fullyQualifiedPackages}")
public class Rule176_ExtensionPackageNameMustBeUnique extends DBBaseRule {

	public Rule176_ExtensionPackageNameMustBeUnique(String baseURI, boolean selfHealingEnabled,
