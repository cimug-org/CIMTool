...
@Rule(name = "Rule026", description = "Names for packages shall be British English names")
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Package, errorTemplate = "{elementType} {name} must be named using British English. Suggested class renaming: {correctedValue}.")
public class Rule026_PackageNameMustBeBritishEnglish extends OntResourceBaseRule {

	public Rule026_PackageNameMustBeBritishEnglish(String baseURI) {
		super(baseURI);
	}
