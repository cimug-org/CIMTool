...
@Rule(name = "Rule196:Rule065", description = "[Rule065] Extension associations shall not have names.")
@RuleMetadata(compositeRule = "Rule196", compositeSubRule = "Rule065", type = RuleType.Extension, category = RuleCategory.Association, errorTemplate = "An extension {elementTypeLowerCase} between classes {domainName} and {rangeName} currently is named {associationName}. This is not allowed in the CIM and should be corrected in the model.")
public class Rule196_Rule065_ExtensionAssociationMustNotBeNamed extends DBBaseRule {

	public Rule196_Rule065_ExtensionAssociationMustNotBeNamed(String baseURI, boolean selfHealingEnabled,
