...
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Association, severity = RuleSeverity.WARN, errorTemplate = "{elementType} {name} end role name must be expressed in the singular.")
public class Rule197_AssociationRoleMustBeSingular extends OntResourceBaseRule {

	public Rule197_AssociationRoleMustBeSingular(String baseURI) {
		super(baseURI);
	}
