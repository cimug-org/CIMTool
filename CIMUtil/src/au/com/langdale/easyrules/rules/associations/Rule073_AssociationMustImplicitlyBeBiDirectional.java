...
@Rule(name = "Rule073", description = "Associations shall implicitly be bi-directional (i.e. the 'Navigability' property of the association ends is unspecified).")
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Association, errorTemplate = "{elementType} {name} must have the *'Navigability'* property of the association ends set as *'Unspecified'*. This should be changed in the model.")
public class Rule073_AssociationMustImplicitlyBeBiDirectional extends DBBaseRule {

	public Rule073_AssociationMustImplicitlyBeBiDirectional(String baseURI, boolean selfHealingEnabled,
