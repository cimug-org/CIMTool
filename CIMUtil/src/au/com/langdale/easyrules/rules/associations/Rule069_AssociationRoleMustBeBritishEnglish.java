...
@Rule(name = "Rule069", description = "Names for association roles shall be British English names.")
@RuleMetadata(type = RuleType.Normative, category = RuleCategory.Association, errorTemplate = "{elementType} {name} must be named using British English. Suggested {elementTypeLowerCase} renaming: {correctedValue}.")
public class Rule069_AssociationRoleMustBeBritishEnglish extends OntResourceBaseRule {

	public Rule069_AssociationRoleMustBeBritishEnglish(String baseURI) {
		super(baseURI);
	}
