...
/**
 * Provisional namespace to represent UML concepts in OWL ontologies. This is
 * used for concepts with no near equivalent in OWL.
 */
...
public class UML {
	...
	public final static Resource TaggedValue = ResourceFactory.createResource(NS + "TaggedValue");
	...
	public final static Resource constrainedprimitive = ResourceFactory.createResource(NS + "constrainedprimitive");
	...
	public final static Resource codelist = ResourceFactory.createResource(NS + "codelist");
	...
	public final static Resource mixin = ResourceFactory.createResource(NS + "mixin");
	public final static Resource legacyCIMExtension = ResourceFactory.createResource(NS + "cimextension");
	public final static Resource extension = ResourceFactory.createResource(NS + "extension");
	public final static Resource xmlelement = ResourceFactory.createResource(NS + "xsdelement");
	public final static Resource xsdattribute = ResourceFactory.createResource(NS + "xsdattribute");
	public final static Resource xsdattributegroup = ResourceFactory.createResource(NS + "xsdattributegroup");
	...
	// Interim solution to support backward compatibility for primitives until
	// nextgen implementation...
	public final static Resource cimdatatypeMapping = ResourceFactory.createResource(NS + "cimdatatypeMapping");

	// Interim solution to support backward compatibility for CIMDatatypes until
	// nextgen implementation...
	...
	static {
		...
		stereotypes.put(constrainedprimitive.getLocalName(), constrainedprimitive);
		...
		stereotypes.put(codelist.getLocalName(), codelist);
		...
		stereotypes.put(xsdattribute.getLocalName(), xsdattribute);
		stereotypes.put(xsdattributegroup.getLocalName(), xsdattributegroup);
	...
	// the tagged values of a model element
	public final static Property hasTaggedValue = ResourceFactory.createProperty(NS + "hasTaggedValue");
	public final static Property tag = ResourceFactory.createProperty(NS + "tag");
	...
	// units and multiplier are not really a UML concepts, we infer these under CIM
	// conventions
	...
	// tags associated with supported XSD facets 
	public final static Property baseType = ResourceFactory.createProperty(NS + "baseType");
	...
	public static void loadOntology(OntModel model) {
		...
		model.createIndividual(codelist.getURI(), Stereotype).addLabel("CodeList", null);
		...
		model.createIndividual(mixin.getURI(), Stereotype).addLabel("MixIn", null);
		model.createIndividual(legacyCIMExtension.getURI(), Stereotype).addLabel("CIMExtension", null);
		...
		model.createIndividual(constrainedprimitive.getURI(), Stereotype).addLabel("ConstrainedPrimitive", null);
		...
		model.createIndividual(xmlelement.getURI(), Stereotype).addLabel("XSDelement", null);
		model.createIndividual(xsdattribute.getURI(), Stereotype).addLabel("XSDattribute", null);
		model.createIndividual(xsdattributegroup.getURI(), Stereotype).addLabel("XSDattributeGroup", null);
		...
		model.createAnnotationProperty(hasTaggedValue.getURI());
		model.createAnnotationProperty(tag.getURI());
		model.createAnnotationProperty(value.getURI());
		...
		model.createAnnotationProperty(baseType.getURI());//
