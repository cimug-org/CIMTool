...
public class IO {
	...
	public static void read(OntModel model, InputStream contents, String namespace,	String syntax) {
		if( syntax.equals(RDF_XML_WITH_NODEIDS)){
			RDFParser parser = new RDFParser(contents, null, namespace, new GraphInjector(model.getGraph()), new Logger(System.out), false);
			parser.run();
		}
		else
	...
	public static void print(OntModel model) {
		write(model, System.out, CIM.NS, "TURTLE", null);
	}
