...
public class NewIncRuleset extends Wizard implements INewWizard {
	...
	public boolean performFinish() {
		return Jobs.runInteractive(Task.createValidationRules(main.getFile(), main.isCopyDefault()? "cimtool-inc":null), main.getFile().getParent(), getContainer(), getShell());
	}
}
