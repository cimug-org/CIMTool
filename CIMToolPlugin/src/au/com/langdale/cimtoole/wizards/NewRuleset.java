...
public class NewRuleset extends FurnishedWizard implements INewWizard {
	...
	public boolean performFinish() {
		return run(Task.createValidationRules(main.getFile(), main.isCopyDefault()? "cimtool-split":null), main.getFile().getParent());
	}
}
