...
public class NewXSDRules extends Wizard implements INewWizard {
	...
	public boolean performFinish() {
		return Jobs.runInteractive(Task.createRules(main.getFile(), main.isCopyDefault()? "xsd":null), main.getFile().getParent(), getContainer(), getShell());
	}
}
