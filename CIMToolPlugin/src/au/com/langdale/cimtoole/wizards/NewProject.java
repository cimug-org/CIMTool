...
public class NewProject extends Wizard implements INewWizard {
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		copyrightTemplates.setDescription(
				"Import and/or configure copyright templates to be used in the artifacts generated by this project.");
	...
	public boolean performFinish() {
		...
		if(pathname != null && pathname.length() != 0) {
			...
			ReportGenerationSettings reportGenerationSettings = schema.getReportGenerationSettings();
			if (reportGenerationSettings.shouldGenerateReport()) {
				job = Task.chain(job, Task.generateImportSchemaReport(schemaFile, reportGenerationSettings));
			}
		}
